...
SECRET_KEY = 'django-insecure-188z(o6ey_w+)glttg9n!31)wi=x9bm@-ynb!tu=nw!klia6z6'
...
#recaptcha
GOOGLE_RECAPTCHA_SECRET_KEY="6LdO__YlAAAAAJ-wr7lPWxcHfZZl7DbVJ4zWA2Bs"
...
TEMPLATES = [
    {
        ...
        'DIRS': ['./appGetionInventario/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
